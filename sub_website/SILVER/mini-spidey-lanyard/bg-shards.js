...
const pointLight1 = new THREE.PointLight(0xdc2626, 3, 50); // Red light
pointLight1.position.set(5, 5, 5);
scene.add(pointLight1);

const pointLight2 = new THREE.PointLight(0x991b1b, 2, 50); // Dark red light
...
// Palette Warna Hero (Merah, Hitam, Silver)
const shardColors = [
  0xdc2626, // Red-600
  0x7f1d1d, // Red-900
  0x1f1f1f, // Near-black
  0x9ca3af  // Silver/gray
];
